      ...
      <div className="w-full px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center">
            ...
            <img src={images["googlelogo_light.svg"]} alt="Google Logo" className="h-8 w-auto" />
          </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="w-8 h-8 bg-violet-500 rounded-full flex items-center justify-center text-white font-bold">
              VS
            </div>
          </div>
        </div>
